...
public final class DateUtil {
    ...
    public static int dateDiff(Date startDate, Date endDate){  
        ...
        daysResult += (endCalendar.get(GregorianCalendar.DAY_OF_MONTH) - startCalendar.get(GregorianCalendar.DAY_OF_MONTH));

        return yearsResult + monthsResult + daysResult;
    }

    /**
     * Returns the minimum value for the day. For example, if the date is "06/06/1974 15:33:12:299" 
     * this method will return a new date such as "06/06/1974 00:00:00:000".
     * 
     * @param date The date.
    ...
    /** 
     * Returns the maximum value for the day. For example, if the date is "06/06/1974 15:33:12:299"
     * this method will return a new date such as "06/06/1974 23:59:59:999".
     * 
     * @param date The date.
