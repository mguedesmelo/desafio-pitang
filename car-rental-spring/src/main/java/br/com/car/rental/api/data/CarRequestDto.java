...
public record CarRequestDto(
		@Min(value = 0, message = "Invalid fields") @NotNull 
		@IsBeforeOrEqualThanCurrentYear @JsonProperty("year") 
		Integer productionYear,

		@NotBlank @NotNull @Length(max = 10) 
		String licensePlate,

		@NotBlank @NotNull @Length(min = 5, max = 60) 
		String model,

		@ValueOfEnum(enumClass = CarColor.class) 
		String color) {
